              ...
              <article class="article">
                ...
                <div class="meta-top">
                  <ul>
                    ...
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01">{{ $post->created_at->format('M j, Y')}}</time></a></li>
            ...
            <div class="recent-posts-widget widget-item">
              ...
              @foreach ($recent_posts as $post)
                 ...
                 <div class="post-item">
                    ...
                    <div>
                      <h4><a href="{{ route('blogs.show', ['slug' => $post->slug ]) }}">{{ $post->title }}</a></h4>
