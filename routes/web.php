...
Route::get('blogs/{post:slug}', [BlogPageController::class, 'show'])->name('blogs.show');
...
Route::get('projects/{project:slug}', [ProjectPageController::class, 'show'])->name('projectspage.show');
